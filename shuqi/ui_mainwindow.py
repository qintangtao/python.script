...
"}"))
        ...
        self.horizontalLayout = QtGui.QHBoxLayout(self.groupBox_type)
        self.horizontalLayout.setObjectName(_fromUtf8("horizontalLayout"))
        self.label_gender = QtGui.QLabel(self.groupBox_type)
        ...
        self.comboBox_minor = QtGui.QComboBox(self.groupBox_type)
        ...
        self.verticalLayout.addWidget(self.groupBox_type)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "免费小说书城", None))
        self.groupBox_type.setTitle(_translate("MainWindow", "分类", None))
