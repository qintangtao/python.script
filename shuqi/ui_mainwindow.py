...
"}"))
        ...
        self.tabWidget_main = QtGui.QTabWidget(MainWindow)
        ...
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.tab_search)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.groupBox_settings = QtGui.QGroupBox(self.tab_search)
        ...
        self.tab_search1 = QtGui.QWidget()
        self.tab_search1.setObjectName(_fromUtf8("tab_search1"))
        self.horizontalLayout_5 = QtGui.QHBoxLayout(self.tab_search1)
        self.horizontalLayout_5.setSpacing(9)
        self.horizontalLayout_5.setObjectName(_fromUtf8("horizontalLayout_5"))
        self.radioButton_name = QtGui.QRadioButton(self.tab_search1)
        self.radioButton_name.setObjectName(_fromUtf8("radioButton_name"))
        self.horizontalLayout_5.addWidget(self.radioButton_name)
        self.radioButton_author = QtGui.QRadioButton(self.tab_search1)
        ...
        self.tabWidget.addTab(self.tab_search1, _fromUtf8(""))
        ...
        self.groupBox_dump = QtGui.QGroupBox(self.tab_search)
        ...
        self.tabWidget_main.addTab(self.tab_search, _fromUtf8(""))
        self.tab_settings = QtGui.QWidget()
        self.tab_settings.setObjectName(_fromUtf8("tab_settings"))
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.tab_settings)
        self.verticalLayout_4.setSpacing(12)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.horizontalLayout_8 = QtGui.QHBoxLayout()
        self.horizontalLayout_8.setObjectName(_fromUtf8("horizontalLayout_8"))
        self.label_page_size = QtGui.QLabel(self.tab_settings)
        self.label_page_size.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_page_size.setObjectName(_fromUtf8("label_page_size"))
        self.horizontalLayout_8.addWidget(self.label_page_size)
        self.comboBox_page_size = QtGui.QComboBox(self.tab_settings)
        self.comboBox_page_size.setObjectName(_fromUtf8("comboBox_page_size"))
        self.horizontalLayout_8.addWidget(self.comboBox_page_size)
        ...
        self.label_task_number = QtGui.QLabel(self.tab_settings)
        self.label_task_number.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.label_task_number.setObjectName(_fromUtf8("label_task_number"))
        self.horizontalLayout_7.addWidget(self.label_task_number)
        self.comboBox_task_number = QtGui.QComboBox(self.tab_settings)
        self.comboBox_task_number.setObjectName(_fromUtf8("comboBox_task_number"))
        self.horizontalLayout_7.addWidget(self.comboBox_task_number)
        ...
        self.checkBox_auto_switch_source_after_failure = QtGui.QCheckBox(self.tab_settings)
        self.checkBox_auto_switch_source_after_failure.setObjectName(_fromUtf8("checkBox_auto_switch_source_after_failure"))
        self.verticalLayout_4.addWidget(self.checkBox_auto_switch_source_after_failure)
        self.checkBox_auto_switch_page_after_completed = QtGui.QCheckBox(self.tab_settings)
        self.checkBox_auto_switch_page_after_completed.setObjectName(_fromUtf8("checkBox_auto_switch_page_after_completed"))
        self.verticalLayout_4.addWidget(self.checkBox_auto_switch_page_after_completed)
        spacerItem3 = QtGui.QSpacerItem(20, 359, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.verticalLayout_4.addItem(spacerItem3)
        self.tabWidget_main.addTab(self.tab_settings, _fromUtf8(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_search1), _translate("MainWindow", "搜索", None))
        ...
        self.label_page_size.setText(_translate("MainWindow", "页大小", None))
        self.label_task_number.setText(_translate("MainWindow", "任务数", None))
        ...
        self.tabWidget_main.setTabText(self.tabWidget_main.indexOf(self.tab_settings), _translate("MainWindow", "设置", None))
