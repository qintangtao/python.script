...
"}"))
        ...
        self.radioButton_status_all = QtGui.QRadioButton(self.tab_cache)
        self.radioButton_status_all.setObjectName(_fromUtf8("radioButton_status_all"))
        self.horizontalLayout_3.addWidget(self.radioButton_status_all)
        self.radioButton_status_unfinished = QtGui.QRadioButton(self.tab_cache)
        self.radioButton_status_unfinished.setObjectName(_fromUtf8("radioButton_status_unfinished"))
        self.horizontalLayout_3.addWidget(self.radioButton_status_unfinished)
        self.radioButton_status_finished = QtGui.QRadioButton(self.tab_cache)
        self.radioButton_status_finished.setObjectName(_fromUtf8("radioButton_status_finished"))
        self.horizontalLayout_3.addWidget(self.radioButton_status_finished)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_status_all.setText(_translate("MainWindow", "全部", None))
        self.radioButton_status_unfinished.setText(_translate("MainWindow", "连载", None))
        self.radioButton_status_finished.setText(_translate("MainWindow", "完结", None))
