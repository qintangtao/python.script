...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit_serialnumber = QtGui.QTextEdit(MainWindow)
        self.textEdit_serialnumber.setReadOnly(True)
        self.textEdit_serialnumber.setObjectName(_fromUtf8("textEdit_serialnumber"))
        self.gridLayout.addWidget(self.textEdit_serialnumber, 2, 2, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "序列号", None))
